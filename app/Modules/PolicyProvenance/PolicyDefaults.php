...
final class PolicyDefaults
{
    ...
    public static function evidence(): array
    {
        return [
            ...
            self::evidenceRecord('POB-COMMUNITY-LICENSE-20260814', 'POB-COMMUNITY', 'bcbca9b60b04abc17935c84ff3589342193bd758', 'https://github.com/PathOfBuildingCommunity/PathOfBuilding/blob/bcbca9b60b04abc17935c84ff3589342193bd758/LICENSE.md', PermissionStatus::Unknown, 'The repository license is MIT, but third-party and GGG-derived portions still require review.', true, 'Retain the Path of Building Community copyright and MIT license notice.'),
