...
final readonly class PatchVersion extends EditionScopedValue
{
    protected static function pattern(): string
    {
        return '/^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:[a-z])?$/D';
    }
    ...
    {
        return 'The patch version must be a canonical edition-scoped patch number.';
    }
}
