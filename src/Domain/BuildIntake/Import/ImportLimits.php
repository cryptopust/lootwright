...
final readonly class ImportLimits
{
    public function __construct(
        ...
        public int $attributeBytes = 2_048,
        public int $xmlTextBytes = 1_048_576,
        public int $unsupportedFeatures = 1_024,
        public int $itemTextLines = 512,
        public int $lineBytes = 2_048,
