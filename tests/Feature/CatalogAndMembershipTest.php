...
final class CatalogAndMembershipTest extends TestCase
{
    ...
    public function test_inactive_poe2_catalog_is_not_publicly_exposed(): void
    {
        $this->getJson('/api/catalog/poe1/character-options')->assertOk();
        $this->getJson('/api/catalog/poe2/character-options')->assertNotFound();
